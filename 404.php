...
<main class="page archive" id="main-content">
    <div class="page--container">
        <div class="page--content">
            ...
            <form role="search" method="get" id="searchform" action="https://caseyocampo.com/">
                <div>
                    <div class="search-box">
                        <p>
                            <label class="screen-reader-text" for="s">Try searching for the topic instead.</label>
                        </p>
                        <input type="text" name="s" id="s" role="searchbox" arial-label="search" />
                    </div>
                    <button type="submit" class="search-button" aria-label="search the blog">
